public class CreatureMagique extends Creature{
    ...
    private boolean aPotionMagique; // Indique si la créature possède une potion magique
    private boolean estMagique; // Indique si la créature est actuellement magique ou non
